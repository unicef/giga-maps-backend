    ...
    return [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education_level_regional', models.CharField(blank=True, max_length=6400007)),
                ('deleted', proco.core.models.CustomDateTimeField(blank=True, db_index=True, null=True)),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='schools', to='giga_meter.GigaMeter_Country')),
            ],
            options={
                'db_table': 'school',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_schools_per_building', models.PositiveIntegerField(blank=True, default=None, null=True)),
                ('version', models.PositiveIntegerField(blank=True, default=None, null=True)),
                ('school', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='gigameter_schools', to='giga_meter.GigaMeter_School', verbose_name='Giga Meter School')),
            ],
            options={
                'db_table': 'master_sync_school_static',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.PositiveIntegerField(blank=True, default=None, null=True)),
                ('status', models.CharField(choices=[('PUBLISHED', 'Insert/Update'), ('DELETED', 'Deleted')], db_index=True, default='PUBLISHED', max_length=50)),
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='school_master_rows', to='giga_meter.GigaMeter_Country')),
            ],
            options={
                'db_table': 'master_sync_intermediate',
                'ordering': ['created'],
        ...
        migrations.AddField(
            model_name='gigameter_school',
            name='last_school_static',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='schools', to='giga_meter.GigaMeter_SchoolStatic'),
        ),
    ]
