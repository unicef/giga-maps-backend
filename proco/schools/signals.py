    ...
    if created or instance.geopoint:
        ...
        if instance.last_weekly_status:
            country_weekly = CountryWeeklyStatus.objects.filter(
                ...
                year=instance.last_weekly_status.year,
                week=instance.last_weekly_status.week,
            ).first()
            if not country_weekly:
                ...
                country_weekly.year = instance.last_weekly_status.year
                country_weekly.week = instance.last_weekly_status.week
                country_weekly.save()
        else:
            country_weekly = CountryWeeklyStatus.objects.filter(
                country_id=instance.country.id,
