...
class DuplicateSchoolFieldValueError(BaseInvalidValidationError):
    message = _("School with {name} '{value}' already exists.")
    code = 'duplicate_school_field_value'


class InvalidSchoolFieldValueError(BaseInvalidValidationError):
    message = _("Field '{name}' has an invalid value.")
    code = 'invalid_school_field_value'
