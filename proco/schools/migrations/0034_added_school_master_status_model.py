# Generated by Django 2.2.28 on 2025-05-08 11:30
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('schools', '0033_added_school_education_level_govt_field'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='created_schoolmasterstatuss', to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('last_modified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='updated_schoolmasterstatuss', to=settings.AUTH_USER_MODEL, verbose_name='Last Updated By')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='master_status', to='schools.School', verbose_name='School Master Sync')),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.AddConstraint(
            model_name='schoolmasterstatus',
            constraint=models.UniqueConstraint(
                condition=models.Q(deleted=None), fields=('school', 'version'),
