...
class SchoolMasterData(TimeStampedModel, core_models.BaseSchoolMaster):
    ...
    school_establishment_year = models.PositiveSmallIntegerField(blank=True, default=None,
                                                                 null=True)  # SchoolMasterStatus.establishment_year
    water_availability = models.CharField(blank=True, null=True, max_length=255)  # SchoolMasterStatus.running_water
    electricity_availability = models.CharField(blank=True, null=True,
                                                max_length=255)  # SchoolMasterStatus.electricity_availability
    ...
    connectivity_type_govt = models.CharField(blank=True, null=True,
                                              max_length=255)  # SchoolWeeklyStatus.connectivity_type
    cellular_coverage_availability = models.CharField(blank=True, null=True,
                                                      max_length=255)  # SchoolWeeklyStatus.coverage_availability
    cellular_coverage_type = models.CharField(blank=True, null=True, max_length=255)  # SchoolWeeklyStatus.coverage_type

    nearest_LTE_distance = models.FloatField(blank=True, default=None,
                                             null=True)  # SchoolMasterStatus.nearest_lte_distance
    nearest_UMTS_distance = models.FloatField(blank=True, default=None,
                                              null=True)  # SchoolMasterStatus.nearest_umts_distance
    nearest_GSM_distance = models.FloatField(blank=True, default=None,
                                             null=True)  # SchoolMasterStatus.nearest_gsm_distance
    nearest_NR_distance = models.FloatField(blank=True, default=None,
                                            null=True)  # SchoolMasterStatus.nearest_nr_distance
    ...
    computer_availability = models.CharField(blank=True, null=True,
                                             max_length=255)  # SchoolMasterStatus.computer_availability

    teachers_trained = models.CharField(blank=True, null=True, max_length=255)  # SchoolMasterStatus.teachers_trained
    sustainable_business_model = models.CharField(blank=True, null=True,
                                                  max_length=255)  # SchoolMasterStatus.sustainable_business_model
    device_availability = models.CharField(blank=True, null=True,
                                           max_length=255)  # SchoolMasterStatus.device_availability
